#SUmirFind_sRNA.pl– Perl script used for detection of small-RNA reads which align to known miRNA
#sequences with three of fewer mismatches. Copyright © Hikmet Budak, 2016. Digital copies of the
...
system ("blastn -task blastn-short -query $mirnaquery -db $blastdatabase -qcov_hsp_perc 100 -ungapped -penalty -1 -reward 1 -strand plus -dust 'no' -evalue 1000 -word_size 7 -outfmt 6 -num_threads 24 -out $mirnaquery.allhits");
...
print FILTEREDHITS "#QueryID\tSubjectID\t%\tlength\tmism\tgaps\tqstart\tqend\tsstart\tsend\tevalue\tbitscore\n";
